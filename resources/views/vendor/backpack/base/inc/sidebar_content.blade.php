...
<li><a href="{{backpack_url('task-manager') }}"><i class="fa fa-file-o"></i> <span>Task Manager</span></a></li>
 -->
<li><a href='{{ url(config('backpack.base.route_prefix', 'admin').'/category') }}'><i class='fa fa-hdd-o'></i> <span>Category</span></a>
</li>
<li><a href='{{ url(config('backpack.base.route_prefix', 'admin').'/product') }}'><i class='fa fa-hdd-o'></i> <span>Product
<li><a href='{{ url(config('backpack.base.route_prefix', 'admin').'/warehousequatity') }}'><i class='fa fa-hdd-o'></i>
                <span>Warehouse Quality</span></a></li>
<li><a href='{{ url(config('backpack.base.route_prefix', 'admin').'/table') }}'><i class='fa fa-hdd-o'></i>
                <span>Table</span></a></li>
<li><a href='{{ url(config('backpack.base.route_prefix', 'admin').'/warehouse') }}'><i class='fa fa-hdd-o'></i> <span>Warehouse</span></a>
</li>
<li><a href='{{ url(config('backpack.base.route_prefix', 'admin').'/tableform') }}'><i class='fa fa-hdd-o'></i> <span>Table Form</span></a>
</li>
